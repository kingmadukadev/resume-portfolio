            ...
            <FadeIn delay={0}>
                <div className='text-center mb-16'>
                    <div className='inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-6'>
                        ...
                        <span className='text-sm text-primary font font-medium tracking-wider uppercase'>What I Offer</span>
                    </div>
                    ...
                    return (
                        <FadeIn key={service.id} delay={300 + index * 100}>
                            <div className='group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300'>
                                <div className='mb-4'>
                                    <div className='w-12 h-1/2 rounded-xl bg-primary/20 border border-primary/30 flex items-center justify-center group-hover:scale-110 transition-transform duration-300'>
