                ...
                <FadeIn delay={200}>
                    <div className='grid grid-cols-2 gap-4'>
                        <div className='col-span-2 relative group'>
                            <div className='absolute inset-0 bg-linear-to-br from-primary/10 to-primary/50 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300'></div>
            ...
            <FadeIn delay={500}>
                <div className='flex flex-col items-center gap-8'>
                    <div className='text-center'>
                        ...
                        <p className='text-sm text-white/60'>Technologies I work with to build an amazing product</p>
                    </div>
                    ...
                    <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 w-full max-w-4xl'>
                        {skills.map((skill, index) => (
                            ...
                            {/* Hover Glow Effect */}
                            <div className='absolute inset-0 bg-linear-to-br from-primary/0 group:hover:from-primary/10 group-hover:to-primary/10 rounded-2xl transition-all duration-300    '></div>
                    </div>
))}
                </div>
                </div>
