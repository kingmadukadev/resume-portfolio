                ...
                <div className='text-left'>
                    <FadeIn delay={0}>
                        <div className='inline-flex items-center gap-2.5 px-4.5 py-2.75 mb-8 bg-linear-to-r from-primary/10 via-primary/15 to-primary/20 border border-primary/20 rounded-full'>
                            ...
                            <span className='text-xs md:text-sm text-white tracking-[1.2px]'>
                                {PERSONAL_INFO.title} | Base in {PERSONAL_INFO.location}
                            </span>
                        </div>
                    </FadeIn>
                    ...
                    <FadeIn delay={100}>
                        <h1 className='text-4xl md:text-5xl lg:text-6xl font-normal text-white mb-6 leading-tight'>
                            Frontend / React.js Developer Portfolio
                        </h1>
                    </FadeIn>
                    ...
                    <div className='relative'>
                        <div className='relative overflow-hidden rounded-2xl aspect-4/5 max-w-125 ml-auto group'>
                            <div className='absolute inset-0 rounded-2xl overflow-hidden'>
                                <div className='absolute -inset-0.5 bg-linear-to-r  from-primary/20 via-primary/10 to-primary animation-spin-slow rounded-2xl'></div>
                            </div>

                            {/* Image Container */}
                            <div className='relative rounded-2xl overflow-hidden m-px h-[calc(100%-2px)]'>
                                <img src={portrait} alt="Developer Portrait" className='' />
                            </div>
