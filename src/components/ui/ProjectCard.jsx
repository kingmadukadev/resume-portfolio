    ...
    <div className='group relative bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-primary/30 transition-all duration-300 '>
        <div className='relative h-64 overflow-hidden'>
          ...
          <div className='absolute bottom-4 right-4 flex items-center gap-3'>
            {demoUrl && (
              <a href={demoUrl} target='_blank' rel='noopener noreferrer' className='p-2.5 bg-white/10 backdrop-blur-md rounded-lg border border-white/20 hover:bg-primary/30 hover:border-primary/50 transition-all duration-300 hover:scale-110' title='View Demo'>
                <ExternalLink className='w-4 h-4 text-white' />
              </a>
            )}
            {githubUrl && (
              <a href={githubUrl} target='_blank' rel='noopener noreferrer' className='p-2.5 bg-white/10 backdrop-blur-md rounded-lg border border-white/20 hover:bg-primary/30 hover:border-primary/50 transition-all duration-300 hover:scale-110' title='View Code'>
